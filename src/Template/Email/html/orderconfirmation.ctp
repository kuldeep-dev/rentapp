...
<body style="padding:15px 0; background: url(http://singhgurpreet.crystalbiltech.com/rentapp/img/bgplait.png) repeat #dddddd;
		margin:0px auto;
...
<table width="600" border="0" cellpadding="10" cellspacing="0" style="margin:0px auto; background:#fffefb; text-align:center;">
  <tr style="background:#fff;">
    <td style="text-align:center; padding-top:2px; padding-bottom:2px; border-bottom:2px solid #5786a6; padding:0;">
    	<img src="http://singhgurpreet.crystalbiltech.com/rentapp/img/emaertillogo.png" alt="img" />
    </td>
  </tr>  
    <tr>
    ...
    <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="f4f4f4"; style="background-color:#f4f4f4;">
          ...
          <tr>
             ...
             <td style="text-align:left; padding: 10px;"><p style="margin:0; font-size:13px">Order No:- <?php if(isset($order['id'])){ echo $order['id']; } ?>
